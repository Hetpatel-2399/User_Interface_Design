...
namespace Chess
{
	...
	public class GameUI
	{
		private ArrayList Squars;	// Array that stores all placeholders for picture control
		public Images ChessImages;	// stores reference of chess pictures
		private string ResourceFolder;		// Contain locaiton of resource folder
		private int LogCounter;         // Stores the sections within the log

		public Game ChessGame;		    // Backend engine
		public Sounds	Sounds;			// game sounds
		...
		public bool ShowMoveHelp;       // Show conceivable move
		public bool IsRunning;			// Return true when the game is running
		public bool IsOver;				// Set to true when the game is over
        public bool ShowComputerThinkingProgres = true;    // whether to show if the computer's turn to be thinkiing
        public bool LastMoveByClick;    // Stores true if the last move was made by mouse click

		public GameUI(ChessMain form)
		{
			this.ParentForm = form;

			// put all the chess images in a list
		...
		private void InitPlayers()
		{
			...
			ParentForm.WhitePlayerImg.Image = ChessGame.WhitePlayer.Image;
			ParentForm.BlackPlayerImg.Image = ChessGame.BlackPlayer.Image;
        ...
        public void SaveGame()
        {
            ...
            saveAsDialog.Filter = "Chess File (*.qcf)|*.qcf";
        ...
        public void LoadGame()
        {
            ...
            openDialog.Title = "Load Chess file...";
            openDialog.Filter = "Chess File (*.qcf)|*.qcf";
		...
		public void NewGame()
		{
			...
			if (NewGameDlg.bStart)
			{
                ...
                if (NewGameDlg.Play_HvC.Checked)
                {
				...
				if (NewGameDlg.Play_CvC.Checked)
				{
					ChessGame.BlackPlayer.PlayerType = Player.Type.Computer;	// Set the black player as computer
